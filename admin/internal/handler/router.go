...
func configNoRoute(r *gin.Engine) {
	r.LoadHTMLGlob("./dist2/*.html") // npm打包成dist的路径
	r.StaticFile("favicon.ico", "./dist/favicon.ico")
	r.Static("/css", "./dist2/css")         // dist里面的静态资源
	r.Static("/fonts", "./dist2/fonts")     // dist里面的静态资源
	r.Static("/js", "./dist2/js")           // dist里面的静态资源
	r.Static("/img", "./dist2/img")         // dist里面的静态资源
	r.StaticFile("/", "./dist2/index.html") // 前端网页入口页面
}
